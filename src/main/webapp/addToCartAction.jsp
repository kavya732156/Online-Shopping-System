...
try{
	...
	ResultSet rs3=stmt.executeQuery("select * from cart where product_id='"+product_id+"' and email='"+email+"' and address is NULL ");
    while(rs3.next()) // if u have laready have the product u will increse the quantity number
    {
    	cart_total=rs3.getInt(5);
